...
Please report issues on [GitHub](https://github.com/cujojs/rest/issues).  Include a brief account of the error, information about the runtime (including shims) and any error messages.
