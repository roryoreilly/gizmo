...
Link: <http://example.com/my-hyper-schema>; rel="describedby"
			...
			<section title="Self-Descriptive Schema">
				<t>
					...
					self-account can be found at <eref target="http://json-schema.org/hyper-schema">http://json-schema.org/hyper-schema</eref>
...
<![CDATA[
{
	"type": ["string", "number"]
			...
			<section title="title" anchor="title">
				<t>This attribute is a string that provides a short account of the instance property.</t>
			</section>
			
			<section title="account" anchor="account">
				<t>This attribute is a string that provides a full account of the of purpose the instance property.</t>
			</section>
		...
		<section title="Hyper Schema" anchor="hyper-schema">
			...
			<section title="links" anchor="links">
				<t>
					...
					in the array is a link account object which describes the link
				...
				<section title="Link Description Object">
					<t>
						A link account object is used to describe link relations. In
						...
						values. The link account format can be used without JSON Schema,
						and use of this format can
						be declared by referencing the normative link account
						schema as the the schema for the data structure that uses the 
						links. The URI of the normative link account schema is:
					...
					<section title="href" anchor="href">
						<t>
							The value of the "href" link account property
				...
				<list style="hanging">
					...
					<t hangText="draft-02">
						<list style="symbols">
							...
							<t>Added "targetSchema" attribute to link account object.</t>
						</list>
					</t>
